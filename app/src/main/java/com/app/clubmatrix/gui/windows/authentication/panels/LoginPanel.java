...
public class LoginPanel extends JPanel {
    ...
    public LoginPanel(Consumer<CredentialsDTO> onLoginAttempt) {
        ...
        addLabelAndField("Username:", usernameField = new JTextField(20), constraints);
        addLabelAndField("Password:", passwordField = new JPasswordField(20), constraints);

        JButton loginButton = new JButton("Login");
        loginButton.addActionListener(e -> onLoginAttempt.accept(
                new CredentialsDTO(
