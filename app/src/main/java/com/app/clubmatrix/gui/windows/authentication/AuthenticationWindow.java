...
public class AuthenticationWindow extends JPanel {
  ...
  public AuthenticationWindow(
    ...
    Consumer<String> onLoginSuccessful
  ) {
    ...
    RegistrationPanel registrationPanel = new RegistrationPanel(
      this::onMemberRegistration,
      this::onEmployeeRegistration
    );
  ...
  private void onLoginAttempt(CredentialsDTO credentials) {
    try {
      ...
      System.err.println(
        "An error occurred while trying to log in: " + e.getMessage()
      );
      JOptionPane.showMessageDialog(
        this,
  ...
  private void onMemberRegistration(
    ...
    try {
      ...
      System.err.println(
        "An error occurred while trying to register: " + e.getMessage()
      );
      JOptionPane.showMessageDialog(
        this,
  ...
  private void onEmployeeRegistration(
