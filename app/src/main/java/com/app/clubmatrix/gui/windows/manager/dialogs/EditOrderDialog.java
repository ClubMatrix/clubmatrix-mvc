...
public class EditOrderDialog extends Dialog {
  ...
  private void saveActivity(ActionEvent event) {
    ...
    Member buyer = userService
      .getUserByUsername((String) buyerField.getSelectedItem())
      .getMember();
    if (buyer == null) {
    ...
    Employee seller = userService
      .getUserByUsername((String) sellerField.getSelectedItem())
      .getEmployee();
    if (seller == null) {
      JOptionPane.showMessageDialog(
        this,
