...
public class RegistrationPanel extends JPanel {
  ...
  public RegistrationPanel(
    Consumer<MemberRegistrationDTO> onRegistrationAttempt,
    Consumer<EmployeeRegistrationDTO> onEmployeeRegistrationAttempt
  ) {
    ...
    addLabelAndTextField(
      "Name:",
      nameField = new UsernameInput(20),
      constraints
    );
  ...
  private JLabel addLabelAndTextField(
    String labelText,
    JComponent field,
