...
public class EmployeeManagementPanel extends JPanel {
    ...
    private void addEmployee(ActionEvent event) {
        AddEmployeeDialog addEmployeeDialog = new AddEmployeeDialog((JFrame) SwingUtilities.getWindowAncestor(this), employeeService);
    ...
    private void editEmployee(ActionEvent event) {
        ...
        if (selectedRow >= 0) {
            Employee selectedEmployee = ((EmployeeTable) employeeTable.getModel()).getEmployeeAt(selectedRow);
            EditEmployeeDialog editEmployeeDialog = new EditEmployeeDialog((JFrame) SwingUtilities.getWindowAncestor(this), employeeService, selectedEmployee);
